...
export default function BadgeToast({ badge, onClose }) {
  ...
  return (
    <motion.div
      ...
      className="fixed top-16 left-1/2 -translate-x-1/2 z-50 bg-gradient-to-r from-yellow-700 to-amber-600 text-white px-4 py-3 rounded-lg shadow-2xl flex items-center gap-3 min-w-[280px] cursor-pointer"
      onClick={onClose}
    >
